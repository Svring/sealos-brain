...
// Transform schema
export const StatefulsetBridgeTransSchema = z.object({
	name: z.any(),
	resourceType: z.any().transform(transformResourceType),
	uid: z.any(),
	image: z.any().transform(transformImage),
	resource: z.any().transform(transformStatefulSetResource),
	...
	env: z.any().transform(transformStatefulSetEnv).optional(),
	...
	localStorage: z.any().transform(transformLocalStorage).optional(),
