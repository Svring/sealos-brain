import type { Env } from "@sealos-brain/k8s/shared/models";
import type { ResourceObject } from "../../resource/models/resource-object.model";
import type { ResourceReliances } from "../models/resource-reliance.model";
