  ...
  (
    ...
    return (
      <section
        ref={ref}
        className={cn(
          "relative z-0 flex w-full flex-col items-center justify-end overflow-hidden rounded-md bg-background",
          className,
        )}
        {...props}
      >
        ...
        <motion.div
          ...
          className="relative z-50 container flex justify-center flex-col px-5 md:px-10 gap-4 pb-4"
        >
